...
builder.Services.AddScoped<IPermisosCatalogoService, PermisosCatalogoService>();
...
builder.Services.AddScoped<ISolucionRepository, MySqlSolucionRepository>();
builder.Services.AddScoped<IConfiguracionCatalogoRepository, MySqlConfiguracionCatalogoRepository>();
builder.Services.AddScoped<IPermisosCatalogoRepository, MySqlPermisosCatalogoRepository>();
